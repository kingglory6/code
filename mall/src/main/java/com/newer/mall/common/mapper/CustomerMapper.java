...
public interface CustomerMapper {
	 ...
	 * @return
	 */
	@Select("select netname,phone,email,password from customer where email=#{email}")
	 ...
	 * @return
	 */
	@Select("select netname,phone,email,password from customer where uid=#{uid}")
	 ...
	 * @param netname
	 */
	@Update("update customer set netname=#{netname},phone=#{phone} where email=#{email}")
	 ...
	 * @param id
	 */
	@Insert("insert into history value(#{uid},#{commodity.id},#{time})")
	 ...
	 * @param id
	 */
	@Insert("insert into collection value(#{uid},#{commodity.id}),#{price},#{time}")
